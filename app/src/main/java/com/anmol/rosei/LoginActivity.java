...
//        });
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    object.put("un",sid);
                    object.put("pw",password);
                    object.put("mode","test");
                                                                ...
                                                                .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                                                    ...
                                                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                                                        ...
                                                                        if (!task.isSuccessful()) {
                                                                            ...
                                                                            final DatabaseReference ref = FirebaseDatabase.getInstance().getReference().getRoot().child("students").child(auth.getCurrentUser().getUid()).child("rosei");
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                StringRequest str = new StringRequest(Request.Method.POST, crypt + encode, new Response.Listener<String>() {
                                                                                    ...
                                                                                    public void onResponse(String response) {
                                                                                        ...
                                                                                        Students students = new Students(sid,response);
